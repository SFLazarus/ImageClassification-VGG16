...
# Feature Engineering
- Zooming: We had to convert 28*28 images to 64*64 images as we are using 5-max pooling layers
- Shuffle: To shuffle every batch will have all variety io images
- Normalization datasets: Alter numeric columns of the dataset to a common scale, without distorting differences in the ranges of values or losing information so that the learning and prediction will not be biased.
...
# Scope for optimizations and further improvements
## ADAM optimization
